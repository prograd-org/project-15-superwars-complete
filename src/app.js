...
class Superwar {
    ...
    checkWin = () => {
        ...
        let result = heroStrength == 0 ? 'villain' : villainStrength == 0 ?'hero' : 'villain';
    ...
    totalStrength = (type) => {
        ...
        let strength = this.players.filter(player => player.type == type).reduce((totalStrength, player) =>totalStrength + player.strength, 0)
        return strength;
    }
